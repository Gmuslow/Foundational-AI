...
#LSTM
# train_losses = [
#     6.3563, 6.2369, 5.8738, 5.7080, 5.6212, 5.5560, 5.5016, 5.4521, 5.4083, 5.3695,
#     5.3333, 5.2969, 5.2655, 5.2349, 5.2044, 5.1721, 5.1422, 5.1145, 5.0872
# ]

# val_losses = [
#     6.3086, 6.0075, 5.7487, 5.6572, 5.5962, 5.5537, 5.5190, 5.4831, 5.4611, 5.4333,
#     5.4175, 5.3965, 5.3816, 5.3681, 5.3476, 5.3322, 5.3184, 5.3031, 5.2919
# ]
